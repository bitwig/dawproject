...
/**
 * Representation of an audio file as a timeline. Duration should be the entire length of the file,
 * any clipping should be done by placing the Audio element within a Clip element. The timeUnit
