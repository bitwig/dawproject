...
public class Utility {
	public static Track createTrack(final String name, final EnumSet<ContentType> contentTypes,
			final MixerRole mixerRole, final double volume, final double pan) {
