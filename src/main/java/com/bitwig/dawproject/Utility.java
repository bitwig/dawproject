...
public class Utility {
	 ...
	 * @param contentTypes
	 *            The content types that can be placed on the track
	 * @param mixerRole
	 *            The mixer role of the track
	 * @param volume
	 *            The volume setting of the track
	 * @param pan
	 *            The panorama setting of the track
	 * @return The track instance
	 */
	public static Track createTrack(final String name, final Set<ContentType> contentTypes, final MixerRole mixerRole,
			final double volume, final double pan) {
	 ...
	 */
	public static Audio createAudio(final String relativePath, final int sampleRate, final int channels,
	 ...
	 *
	 * @param time
	 *            The time position of the marker
	 * @param name
	 ...
	 *
	 * @param time
	 *            The time position of the point
	 * @param value
	 ...
	 * @return The parameter
	 */
	public static RealParameter createRealParameter(final Unit unit, final double min, final double max,
			final double value) {
