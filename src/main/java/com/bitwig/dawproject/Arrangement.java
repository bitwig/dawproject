...
public class Arrangement extends Referenceable
{
    ...
    /**
     * Automation data for tempo inside this Arrangement, which will define the conversion between
     * seconds and beats at the root level.
     */
    ...
    /**
     * The lanes of this arrangement. Generally this would contain another Lanes timeline for (and
     * scoped to) each track which would then contain all Note, Audio, and Automation timelines.
     */
