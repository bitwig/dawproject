...
public class DawProjectTest
{
    ...
    private static void createAudioExample (final double playStartOffset, final double clipTime, final AudioScenario scenario, final boolean withFades) throws IOException
    {
    ...
    private static void createMIDIAutomationExample (final String name, final boolean inClips, final boolean isPitchBend) throws IOException
    {
        final Project project = createEmptyProject ();
        final Track masterTrack = Utility.createTrack ("Master", EnumSet.noneOf (ContentType.class), MixerRole.MASTER, 1, 0.5);
